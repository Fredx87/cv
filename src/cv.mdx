...
* <FontAwesomeIcon icon={faGithub} fixedWidth /> <a
    href="https://github.com/Fredx87"
    target="_blank"
  >
    Fredx87
  </a>
* <FontAwesomeIcon icon={faLinkedin} fixedWidth /> <a
    href="https://www.linkedin.com/in/gianluca-frediani/"
    target="_blank"
  >
    gianluca-frediani
  </a>
...
- **Frontend**: TypeScript, JavaScript, HTML, CSS, SASS, React, Redux, Styled Components, fp-ts, io-ts, Web components, Angular, AngularJS, RxJS, GatsbyJS
- **Backend**: Node.js, Serverless Framework, C#, Java, MySQL
- **Testing**: Cypress, Jest,
- **Tools**: Git, Docker, Jenkins, Github Actions, Gitlab CI, NPM, Webpack
- **Other**: OpenAPI, MQTT, Amazon Web Services, functional programming
- **Desktop**: C++, Qt
...
### Software Engineer
- Bootstrap of the Dixa Messenger Product, a chat widget embeddable in websites
- Design of external APIs (both for end users and w.r.t. the backend communication)
- Design of the frontend architecture, with focus on WebSocket communication, iframe handling, type safety, and a design system based on Styled Components
- Setup and implementation of unit tests with Jest and integration/E2E tests with Cypress
- Implementation of CI/CD on Github Actions
...
- <a href="https://github.com/Fredx87/openapi-io-ts" target="_blank">
    openapi-io-ts
  </a>
  <br />
  TypeScript, fp-ts, io-ts, io-ts-codegen, OpenAPI, JSON Schema

- <a href="https://github.com/Fredx87/openapi-mock-generator" target="_blank">
    OpenAPI Mock Generator
  </a>
  <br />
  TypeScript, React, Redux, Cypress, fp-ts, Ant Design, IndexedDB, PWA, Styled
  Components, Github Actions
- <a
    href="https://github.com/Fredx87/cypress-keycloak-commands"
    target="_blank"
  >
